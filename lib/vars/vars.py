...
if getattr(sys, 'frozen', False):
    USER_DATA_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(sys.executable))), 'user_data')
    USER_EC2_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(sys.executable))), 'ec2_key')
elif __file__:
